...
function repintarMesaDePlanejamento() {
  ...
  // Quem esta na mesa e DA_PLANNING_PESSOAS, e nao daControllerPersonId — este
  // vale 'all' quando o filtro do DA nao aponta ninguem, e 'all' nao e pessoa:
  // a abertura nao achava o usuario e desistia em silencio, entao a mesa nunca
  // se repintava. Reabrir por alguem que JA esta na mesa preserva as mesas de
  // duas ou tres pessoas, como a propria abertura documenta.
