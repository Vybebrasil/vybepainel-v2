...
async function salvarCampoDaFicha(itemId, campo, valor, alvo) {
  ...
  drawer.innerHTML = `
    ...
    <details class="workspace-section workspace-recolhida"><summary>Entrega guiada<small>o mesmo que anexar acima</small></summary><div class="workspace-section-head-oculta"><div class="workspace-section-body"><p class="workspace-note">Para concluir com continuidade: anexe ou registre o link final, atualize o status e deixe a passagem de bastão para a próxima etapa.</p><input id="workspace-link-input" class="workspace-input" type="url" placeholder="Cole o link do Drive, Frame.io ou Canva"><div class="workspace-form-row"><button type="button" class="workspace-action primary" onclick="saveWorkspaceLink()">1. Registrar link da entrega</button><button type="button" class="workspace-action" onclick="openManualHandoff('${item.id}')">2. Passar bastão</button></div></div></details>
    <details class="workspace-section workspace-recolhida workspace-handoff"><summary>Passagem de bastão<small>nunca usada em 200 peças</small></summary><div class="workspace-section-body"><p class="workspace-note">Registre o que foi concluído, o que precisa acontecer agora e o link ou arquivo que ajuda a próxima pessoa.</p><button type="button" class="workspace-action" onclick="openManualHandoff('${item.id}')">Registrar passagem estruturada</button></div></details>
