...
function focusDailyPlanHtml(items,user,nextAction) {
  ...
  return `<section class="focus-daily-plan"><div class="focus-daily-plan-head"><div><span>Plano do dia</span></div></div><div class="focus-daily-plan-grid">${row('AGORA',inProgress[0] || next,'sem execução registrada')}${''/* "PRÓXIMA" saiu daqui: o bloco grande logo abaixo E a proxima, com o mesmo
